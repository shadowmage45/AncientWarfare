 ...
 */
package shadowmage.ancient_vehicles.common.vehicles;
...
import shadowmage.ancient_vehicles.common.vehicles.VehicleVarHelpers.DummyVehicleHelper;
import shadowmage.ancient_vehicles.common.vehicles.armors.IVehicleArmorType;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehicleAmmoHelper;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehicleFiringHelper;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehicleFiringVarsHelper;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehicleMoveHelper;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehiclePacketDataManager;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehicleUpgradeHelper;
import shadowmage.ancient_vehicles.common.vehicles.materials.IVehicleMaterial;
...
public float getEffectiveRange(float verticalOffset)
  ...
  return TrajectoryCalculator.getEffectiveRange(verticalOffset, angle, firingHelper.getAdjustedMaxMissileVelocity(), 0, ammoHelper.getCurrentAmmoType()!=null && ammoHelper.getCurrentAmmoType().isRocket());  
  }
