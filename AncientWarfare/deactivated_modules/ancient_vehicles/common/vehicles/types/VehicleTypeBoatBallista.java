...
import shadowmage.ancient_vehicles.common.vehicles.VehicleVarHelpers.BallistaVarHelper;
...
public String getTextureForMaterialLevel(int level)
  ...
  switch(level)
    {
    case 0:
    return Statics.TEXTURE_PATH + "models/boatBallista1.png";
    case 1:
    return Statics.TEXTURE_PATH + "models/boatBallista2.png";
    case 2:
    return Statics.TEXTURE_PATH + "models/boatBallista3.png";
    case 3:
    return Statics.TEXTURE_PATH + "models/boatBallista4.png";
    case 4:
    return Statics.TEXTURE_PATH + "models/boatBallista5.png";
    default:
    return Statics.TEXTURE_PATH + "models/boatBallista1.png";
    }
  }
