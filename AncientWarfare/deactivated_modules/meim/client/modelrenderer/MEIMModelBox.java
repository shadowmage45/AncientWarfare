...
public MEIMModelBox(MEIMModelRenderer par1ModelRenderer, int par2, int par3, float par4, float par5, float par6, int par7, int par8, int par9, float par10)
  {
  this.posX1 = par4;
  this.posY1 = par5;
  this.posZ1 = par6;
...
public void render(Tessellator par1Tessellator, float par2)
 ...
 public MEIMModelBox func_78244_a(String par1Str)
   {
