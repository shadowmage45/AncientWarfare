...
import shadowmage.ancient_vehicles.common.vehicles.VehicleMovementType;
import shadowmage.ancient_vehicles.common.vehicles.helpers.VehicleFiringVarsHelper;
import shadowmage.ancient_vehicles.common.vehicles.materials.VehicleMaterial;
import shadowmage.ancient_vehicles.common.vehicles.missiles.Ammo;
...
public VehicleTypeHelicopter(int typeNum)
  ...
  this.additionalMaterials.add(new ItemStackWrapperCrafting(ItemLoaderCore.powderCase, 2, false, false));
  this.additionalMaterials.add(new ItemStackWrapperCrafting(ItemLoaderCore.equipmentBay, 1, false, false));
  this.additionalMaterials.add(new ItemStackWrapperCrafting(ItemLoaderCore.mobilityUnit, 2, false, false));
...
public String getTextureForMaterialLevel(int level)
  ...
  switch(level)
    {
    case 0:
    return Statics.TEXTURE_PATH + "models/helicopter1.png";
    case 1:
    return Statics.TEXTURE_PATH + "models/helicopter2.png";
    case 2:
    return Statics.TEXTURE_PATH + "models/helicopter3.png";
    case 3:
    return Statics.TEXTURE_PATH + "models/helicopter4.png";
    case 4:
    return Statics.TEXTURE_PATH + "models/helicopter5.png";
    default:
    return Statics.TEXTURE_PATH + "models/helicopter1.png";
    }
  }
