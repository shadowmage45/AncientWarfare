...
public ModelChestCart(){
  ...
  setPieceRotation(cartHitchLeft,0.0f, 0.17453237f, 0.0f);
  ...
  cartHitchFront.setRotationPoint(0.0f, -1.5f, -23.0f);
  setPieceRotation(cartHitchFront,0.0f, 0.0f, 0.0f);
  cartHitchFront.addBox(-11.0f,-0.5f,-0.5f,22,1,1);
