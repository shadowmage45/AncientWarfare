...
public class GuiNpcCraft extends GuiCraftingTabbed
{

/**
 * @param container
 */
public GuiNpcCraft(Container container)
  {
  super(container);
...
public EnumSet<RecipeType> getTab1RecipeTypes()
  {
  return EnumSet.of(RecipeType.NPC);
  }

@Override
public EnumSet<RecipeType> getTab2RecipeTypes()
  {
  return EnumSet.of(RecipeType.NPC_MISC);
  }
