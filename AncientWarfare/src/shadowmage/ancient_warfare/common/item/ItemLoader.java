...
public static final AWItemBase armorItem = new ItemVehicleArmor(AWCore.instance.config.getItemID("itemMulti.vehicleArmor", 24010, "Vehicle Armor Component"));
public static final AWItemBase npcSpawner = new ItemNpcSpawner(AWCore.instance.config.getItemID("itemMulti.npcSpawner", 24011, "Npc Spawning Item"));
public static final AWItemBase npcCommandBaton = new ItemNpcCommandBaton(AWCore.instance.config.getItemID("itemMulti.commandBaton", 24012, "Npc Command Batons"));
public static final AWItemBase civicPlacer = new ItemCivicPlacer(AWCore.instance.config.getItemID("itemMulti.civiPlacer", 24024, "Constructs Civic Buildings/Sites"));
