 ...
 * @param id
 */
public CivicFishFarm(int id, String name, String tooltip, Class <?extends TEWorkSite> teClass, String iconTex, int workHorizSize, int workVertSize)
  {
  super(id);
  ...
  this.blockIconNames[2] = "ancientwarfare:civic/civicFarmFishSide";  
