 ...
 * 
 */
public TEFarmMushroomRed()
  {
  this.mainBlockID = Block.mushroomRed.blockID;
  this.mainBlockMatureMeta = 0;
  this.plantableFilter = new ItemStack(Block.mushroomRed);
  }
...
protected TargetType validateWorkPoint(int x, int y, int z)
  ...
  if( x%4==0 && z%4 ==0)
    {
    if(id==0 &&Block.mushroomRed.canBlockStay(worldObj, x, y, z) && inventory.containsAtLeast(plantableFilter, 1))
      {      
