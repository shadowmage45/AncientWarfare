...
public abstract String getTaskName();//the name of the task..for debug/information referencing...
...
public abstract void onAiStarted();
public abstract void onTick();//apply your AI actions to the NPC here.  Called during the AI update loop, only if shouldExecute()==true && ticksTilTry<=0
