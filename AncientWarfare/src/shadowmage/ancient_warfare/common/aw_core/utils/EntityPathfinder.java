...
public EntityPathfinder(Entity vehicle, World worldIn, float searchRange)
  {
  this.entity = vehicle;
  this.worldObj = worldIn;
  this.pathSearchRange = searchRange;
  }
...
public PathEntity getPathToXYZ(double par1, double par3, double par5)
  {
  return !this.canNavigate() ? null : this.worldObj.getEntityPathToXYZ(this.entity, MathHelper.floor_double(par1), (int)par3, MathHelper.floor_double(par5), this.pathSearchRange, this.canPassOpenWoodenDoors, this.canPassClosedWoodenDoors, this.avoidsWater, this.canSwim);
  }
...
public PathEntity getPathToEntityLiving(EntityLiving par1EntityLiving)
  {
  return !this.canNavigate() ? null : this.worldObj.getPathEntityToEntity(this.entity, par1EntityLiving, this.pathSearchRange, this.canPassOpenWoodenDoors, this.canPassClosedWoodenDoors, this.avoidsWater, this.canSwim);
  }
...
public void onUpdateNavigation()
  ...
  if (!this.noPath())
    ...
    if (!this.noPath())
      {
      Vec3 var1 = this.currentPath.getPosition(this.entity);
      if (var1 != null)
        {
//        if(entity instanceof VehicleBase)
//          {
//          ((VehicleBase) entity).moveHelper.setMoveTo(var1.xCoord, var1.yCoord, var1.zCoord);
//          }        
        }
      }
    }
...
private void pathFollow()
  ...
  float var8 = this.entity.width * this.entity.width;
  int var4;

  for (var4 = this.currentPath.getCurrentPathIndex(); var4 < var2; ++var4)
    {
    if (var1.squareDistanceTo(this.currentPath.getVectorFromIndex(this.entity, var4)) < (double)var8)
      {
      this.currentPath.setCurrentPathIndex(var4 + 1);
      }
    }

  var4 = MathHelper.ceiling_float_int(this.entity.width);
  int var5 = (int)this.entity.height + 1;
  int var6 = var4;

  for (int var7 = var2 - 1; var7 >= this.currentPath.getCurrentPathIndex(); --var7)
    {
    if (this.isDirectPathBetweenPoints(var1, this.currentPath.getVectorFromIndex(this.entity, var7), var4, var5, var6))
      {
 ...
 */
 ...
 private Vec3 getEntityPosition()
   {
   return this.worldObj.getWorldVec3Pool().getVecFromPool(this.entity.posX, (double)this.getPathableYPos(), this.entity.posZ);
   }
 ...
 private int getPathableYPos()
   ...
   if (this.entity.isInWater() && this.canSwim)
     {
     int var1 = (int)this.entity.boundingBox.minY;
     int var2 = this.worldObj.getBlockId(MathHelper.floor_double(this.entity.posX), var1, MathHelper.floor_double(this.entity.posZ));
     int var3 = 0;
     ...
     do
       ...
       ++var1;
       var2 = this.worldObj.getBlockId(MathHelper.floor_double(this.entity.posX), var1, MathHelper.floor_double(this.entity.posZ));
       ++var3;
       }
     while (var3 <= 16);
 ...
 private boolean canNavigate()
   {
   return this.entity.onGround || this.canSwim && this.isInFluid();
   }
 ...
 private void removeSunnyPath()
   {
   if (!this.worldObj.canBlockSeeTheSky(MathHelper.floor_double(this.entity.posX), (int)(this.entity.boundingBox.minY + 0.5D), MathHelper.floor_double(this.entity.posZ)))
     {
     ...
     for (int var14 = var12; var14 < var12 + par4; ++var14)
       ...
       for (int var15 = var13; var15 < var13 + par6; ++var15)
         ...
         if (var16 * par8 + var18 * par10 >= 0.0D)
           ...
           if (var21 == Material.water && !this.entity.isInWater())
             {
             return false;
             }
