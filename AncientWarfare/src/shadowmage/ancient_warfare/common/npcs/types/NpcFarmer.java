...
public NpcFarmer(int type)
  ...
  this.addLevel(type, 0, Config.texturePath + "models/npc/npcFarmer.png", getToolStack(0), null).addTargetType(CivicWorkType.FARM, CivicWorkType.ENGINE).setActionTicks(40).setUpkeep(4).addNeededResearch(ResearchGoalNumbers.logistics1);
  this.addLevel(type, 1, Config.texturePath + "models/npc/npcFarmer.png", getToolStack(1), null).addTargetType(CivicWorkType.FARM, CivicWorkType.ENGINE).setActionTicks(30).setUpkeep(6).addNeededResearch(ResearchGoalNumbers.logistics3);
