...
public NpcCombatEngineer(int type)
  ...
  this.addLevel(type, 0, Statics.TEXTURE_PATH + "models/npcDefault.png", getToolStack(0), getArmorStack(0)).setAttackDamage(3).setUpkeep(6).addNeededResearch(ResearchGoalNumbers.command1).setHealingDone(4);
  this.addLevel(type, 1, Statics.TEXTURE_PATH + "models/npcDefault.png", getToolStack(1), getArmorStack(1)).setAttackDamage(4).setUpkeep(8).addNeededResearch(ResearchGoalNumbers.command2).setHealingDone(8);
  this.addLevel(type, 2, Statics.TEXTURE_PATH + "models/npcDefault.png", getToolStack(2), getArmorStack(2)).setAttackDamage(5).setUpkeep(10).addNeededResearch(ResearchGoalNumbers.command3).setHealingDone(12);
  }
