...
public NpcCommander(int type)
  ...
  this.addLevel("General", Config.texturePath + "models/npcDefault.png", getToolStack(2), getArmorStack(2)).setAttackDamage(8).setUpkeep(12).addNeededResearch(ResearchGoalNumbers.command3);  
  }
