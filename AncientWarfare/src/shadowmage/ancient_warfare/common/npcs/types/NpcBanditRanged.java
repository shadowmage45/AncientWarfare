...
public NpcBanditRanged(int type)
  ...
  this.isBandit = true;
  this.addLevel(type, 0, Statics.texturePath + "models/npcDefault.png", getToolStack(0), getArmorStack(0)).setRange(20).setAccuracy(0.88f).setUpkeep(6);
  this.addLevel(type, 1, Statics.texturePath + "models/npcDefault.png", getToolStack(1), getArmorStack(1)).setRange(20).setAccuracy(0.91f).setUpkeep(8);
  this.addLevel(type, 2, Statics.texturePath + "models/npcDefault.png", getToolStack(2), getArmorStack(2)).setRange(20).setAccuracy(0.94f).setUpkeep(8);
  this.addLevel(type, 3, Statics.texturePath + "models/npcDefault.png", getToolStack(3), getArmorStack(3)).setRange(20).setAccuracy(0.97f).setUpkeep(10);
