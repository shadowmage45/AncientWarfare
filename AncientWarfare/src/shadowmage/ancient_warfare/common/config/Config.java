...
{
//*******************************************************FIELDS**********************************************//
public static final String VERSION = "1.0.038-beta-MC152";//major version(major revision).minor version(mc updates).build_version(the actual indiv release)-build state (beta)-MC version-automated build number (optional)
