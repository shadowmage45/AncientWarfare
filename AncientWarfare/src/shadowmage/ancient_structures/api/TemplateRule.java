...
//only non-final so that templateRuleEnitty may extend it
...
public final static void writeRuleLines(TemplateRule rule, BufferedWriter out, String ruleType, IStructurePluginLookup manager) throws IOException
  {
  if(rule==null)
    {
    return;
    }
  String id = manager.getPluginNameFor(rule.getClass());
  if(id==null)
    {
    return;
    }
