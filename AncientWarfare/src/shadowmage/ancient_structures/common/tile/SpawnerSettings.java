...
public void readFromNBT(NBTTagCompound tag)
  ...
  NBTTagList groupList = tag.getTagList("spawnGroups");
  EntitySpawnGroup group;
  for(int i = 0; i < groupList.tagCount(); i++)
    {
    group = new EntitySpawnGroup();
    group.readFromNBT((NBTTagCompound) groupList.tagAt(i));
...
public void readFromNBT(NBTTagCompound tag)
  ...
  NBTTagList settingsList = tag.getTagList("settingsList");
  EntitySpawnSettings setting;
  for(int i = 0; i < settingsList.tagCount(); i++)
    {
    setting = new EntitySpawnSettings();
    setting.readFromNBT((NBTTagCompound) settingsList.tagAt(i));
