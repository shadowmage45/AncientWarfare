 ...
 * the struct)
 */
private Set<StructureBuilder> openBuilders = new HashSet<StructureBuilder>();
...
public void addBuilder(StructureBuilder build)
  {
//  Config.logDebug("adding builder");
  this.openBuilders.add(build);
  }

public void removeBuilder(StructureBuilder build)
  {
