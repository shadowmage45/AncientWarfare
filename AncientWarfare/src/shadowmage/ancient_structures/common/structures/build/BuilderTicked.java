 ...
 *
 */
public class BuilderTicked extends StructureBuilder
{
...
public void onTick()
  ...
  if(world==null)
    {
    AWLog.logError("Builder being ticked with a null World!");
    return;
    }
  if(this.isFinished)
    {
    AWLog.logError("Ticking finished ticked-builder, was not removed from list when finished");
    return;
    }
